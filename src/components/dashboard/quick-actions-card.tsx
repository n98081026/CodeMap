...
export const QuickActionsCard: React.FC<QuickActionsCardProps> = React.memo(
    ...
    return (
      <Card className='shadow-lg'>
        ...
        <CardContent className='grid gap-4 sm:grid-cols-1 md:grid-cols-2'>
          {' '}
          {/* Adjusted grid for potentially wider items */}
          {actions.map((action) => (
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        size='icon'
                        onClick={() =>
                          startOrResumeTutorial(action.tutorialKey!, 0, true)
                        }
                        aria-label={
                          action.tutorialButtonTooltip ||
                          `Show ${action.label} tutorial`
                        }
                    ...
                    <TooltipContent>
                      <p>
                        {action.tutorialButtonTooltip ||
                          `Show tutorial for "${action.label}"`}
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
