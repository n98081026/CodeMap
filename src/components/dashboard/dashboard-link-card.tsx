...
export const DashboardLinkCard: React.FC<DashboardLinkCardProps> = React.memo(
      ...
      <Card className='shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col'>
        ...
        <CardContent className='flex-grow flex flex-col'>
          <div className='flex-grow'>
            ...
            <p className='text-xs text-muted-foreground mb-4 min-h-[2.5rem] line-clamp-2'>
              {' '}
              {/* min-h ensure space for 2 lines */}
              {description}
            </p>
          </div>
          <Button
