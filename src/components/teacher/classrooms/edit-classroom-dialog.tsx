...
export function EditClassroomDialog({ isOpen, onOpenChange, classroomToEdit, onClassroomUpdateSuccess }: EditClassroomDialogProps) {
  ...
  }, [classroomToEdit, editFormData, toast, onOpenChange, onClassroomUpdateSuccess]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <FormDialogHeader>
          <FormDialogTitle>Edit Classroom: {classroomToEdit.name}</FormDialogTitle>
