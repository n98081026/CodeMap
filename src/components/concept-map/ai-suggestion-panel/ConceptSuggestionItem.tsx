  ...
  return (
    <div
      className={cn(
        ...
        isSelected ? 'bg-blue-50 border-blue-200 dark:bg-blue-950 dark:border-blue-800' : 'bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700'
      )}
    ...
    >
      ...
      {/* Status indicator */}
      <div className={cn('flex items-center gap-1 text-xs', getStatusColor(itemStatus))}>
          ...
          <div className="text-xs text-muted-foreground mt-1 space-y-1">
            {item.current.context && (
              <div className="truncate">
                <span className="font-medium">Context:</span> {item.current.context}
              </div>
            )}
            {item.current.source && (
              <div className="truncate">
                <span className="font-medium">Source:</span> {item.current.source}
              </div>
            )}
          </div>
        )}
