...
const MemoizedOrthogonalEdge = memo(
  React.lazy(() =>
...
export const OptimizedFlowCanvas: React.FC<OptimizedFlowCanvasProps> = memo(
  ({
    ...
    const { measurePerformance, debouncedCompute, throttle } =
    ...
    const [rfNodes, setRfNodes, onNodesChangeReactFlow] =
      useNodesState(optimizedNodes);
    const [rfEdges, setRfEdges, onEdgesChangeReactFlow] =
      useEdgesState(optimizedEdges);
