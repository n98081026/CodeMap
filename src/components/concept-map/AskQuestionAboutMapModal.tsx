...
export const AskQuestionAboutMapModal: React.FC<AskQuestionAboutMapModalProps> = ({
  isOpen,
  onOpenChange,
  mapName,
  onSubmitQuestion,
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs text-muted-foreground pt-1">
            Ask a general question about the overall structure, themes, or relationships within this concept map.
          </DialogDescription>
        </DialogHeader>
