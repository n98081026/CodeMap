...
export function EditProfileDialog({
  ...
  const isPredefinedMockUser =
    currentUser.id === 'admin-mock-id' ||
    currentUser.id === 'student-test-id' ||
    currentUser.id === 'teacher-test-id';
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4'>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      disabled={isSaving || isPredefinedMockUser}
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem>
                  ...
                  {isPredefinedMockUser && (
                    <p className='text-xs text-muted-foreground'>
                      Email for pre-defined mock accounts cannot be changed.
                    </p>
                  )}
                  {!isPredefinedMockUser && (
                    <p className='text-xs text-muted-foreground'>
                      Updating email here changes your profile record. To change
                      your login email, additional steps might be required
                      depending on Supabase email change confirmation settings.
                    </p>
                  )}
                  <FormMessage />
                </FormItem>
            ...
            <DialogFooter>
              ...
              <Button
                type='submit'
                disabled={
                  isSaving || isPredefinedMockUser || !form.formState.isDirty
                }
              >
