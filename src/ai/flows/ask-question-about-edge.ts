...
export const AskQuestionAboutEdgeInputSchema = z.object({
  ...
  sourceNodeDetails: z.string().optional().describe("Optional details or description of the source node."),
  targetNodeId: z.string().describe("ID of the target node."),
  targetNodeText: z.string().describe("Text/label of the target node."),
  targetNodeDetails: z.string().optional().describe("Optional details or description of the target node."),
  edgeId: z.string().describe("ID of the edge."),
  edgeLabel: z.string().optional().describe("Optional label of the edge describing the relationship."),
  userQuestion: z.string().describe("The user's question about this edge and its context."),
});
export type AskQuestionAboutEdgeInput = z.infer<typeof AskQuestionAboutEdgeInputSchema>;
...
export type AskQuestionAboutEdgeOutput = z.infer<typeof AskQuestionAboutEdgeOutputSchema>;
...
export const askQuestionAboutEdgeFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    try {
      ...
      if (!output) {
        return {
          answer: "The AI was unable to generate an answer for your question about this edge.",
      ...
      return {
        answer: "An error occurred while the AI was processing your question about this edge.",
