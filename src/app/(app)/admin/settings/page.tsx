...
const settingsFormSchema = z.object({
  ...
  default_concept_map_visibility: z
    .enum(['public', 'private'])
    .default('private'),
...
export default function AdminSettingsPage() {
  ...
  const [errorLoadingSettings, setErrorLoadingSettings] = useState<
    string | null
  >(null);
  ...
  const fetchSettings = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${errorMessage}. Using default values.`,
        variant: 'destructive',
      });
        ...
        <Card className='border-destructive bg-destructive/10'>
          ...
          <CardContent>
            ...
            <p className='text-sm text-destructive/80 mt-1'>
              Displaying default values. Please try saving or reloading.
            </p>
          </CardContent>
        </Card>
      )}
                  ...
                  <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                    <div className='space-y-0.5'>
                      <FormLabel className='text-base'>
                        Enable AI Project Analysis
                      </FormLabel>
                      <FormDesc>
                        Allow users to generate concept maps from project
                        submissions using AI.
                      </FormDesc>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDesc>
                      Sets the initial visibility for concept maps created by
                      users.
                    </FormDesc>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDesc>
                      Define the maximum allowable size for project archive
                      uploads (1-100 MB).
                    </FormDesc>
                    <FormMessage />
                  </FormItem>
