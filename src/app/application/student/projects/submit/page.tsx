  ...
  useEffect(() => {
    ...
    if (tutorialState && !tutorialState.projectUploadSeen) {
      const tour = new Shepherd.Tour({
        ...
        defaultStepOptions: {
          classes:
            'shadow-md bg-background text-foreground border border-border rounded-lg', // Example custom class for popups
      ...
      tour.addStep({
        ...
        when: {
          // This is a Shepherd feature, but might need custom logic if element presence varies
          show: () => {
